...
export default function Hero() {
    ...
    // if (loading) {
    //     return (
    //         <section className="relative overflow-hidden bg-gradient-to-br from-orange-100 to-red-100 pt-16 min-h-screen">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {features.map(({ id, title, desc, icon: Icon, bgColor, border, iconBg }) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-600 text-sm lowercase">{desc}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
